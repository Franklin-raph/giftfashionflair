...
const Products = () => {
    ...
    return (
        <div className='mt-[5rem]'>
            ...
            {/* Page Header */}
            <div className='bg-[#F2F0FF] py-14 text-center'>
                <h1 className='text-[#1A0B5B] font-bold text-[40px]'>All Products</h1>
                <p className='text-[#8A8FB9] mt-2'>Browse our full collection — fashion for every vibe</p>
            </div>

            <div className='max-w-[1200px] mx-auto px-10 md:px-0 mt-10'>
                ...
                {/* Results Count */}
                <p className='text-[#8A8FB9] text-sm mb-6'>{filtered.length} product{filtered.length !== 1 ? 's' : ''} found</p>

                {/* Products Grid */}
                {filtered.length > 0 ? (
                    <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 mb-[5rem]'>
